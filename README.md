...
KiCad hardware design (schematics + PCB) for the Arduino NMR 5.4 project.

## Layout

- `Arduino_NMR_5.4.kicad_pro` / `.kicad_sch` / `.kicad_pcb` — main KiCad project, schematic, and board
...
Requires [KiCad](https://www.kicad.org/) 7 or later. Open `Arduino_NMR_5.4.kicad_pro`.
